        ...
        <div className="mx-auto max-w-[1500px] px-5 py-24 sm:px-8 lg:px-10">
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Feature
              number="01"
              title="Discover"
              text="Search land by location, purpose, area and suitability."
            />

            <Feature
              number="02"
              title="Understand"
              text="AI and GIS intelligence reveals the potential of each parcel."
            />

            <Feature
              number="03"
              title="Verify"
              text="Listings move through verification before receiving trust status."
            />

            <Feature
              number="04"
              title="Connect"
              text="Connect owners with businesses, investors and developers."
            />

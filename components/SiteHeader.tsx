      ...
      {menu && (
        <div className="border-t border-white/[0.06] bg-[#070908]/98 px-5 py-6 lg:hidden">
          <div className="flex flex-col gap-5">
            <MobileLink href="/" onClick={() => setMenu(false)}>
              Home
            </MobileLink>
            <MobileLink href="/explore" onClick={() => setMenu(false)}>
              Explore
            </MobileLink>
            <MobileLink href="/intelligence" onClick={() => setMenu(false)}>
              Intelligence
            </MobileLink>
            <MobileLink href="/how-it-works" onClick={() => setMenu(false)}>
              How it works
            </MobileLink>
            <MobileLink href="/investment" onClick={() => setMenu(false)}>
              Investment
            </MobileLink>
            <MobileLink href="/about" onClick={() => setMenu(false)}>
              About
            </MobileLink>
            <MobileLink href="/contact" onClick={() => setMenu(false)}>
              Contact
            </MobileLink>
            <MobileLink href="/signup" onClick={() => setMenu(false)}>
              Sign in
            </MobileLink>
          </div>
        </div>
